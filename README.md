...
└── images/          画像置き場(差し替え用)
    ...
    │    …(GL-03 〜 GL-15)…
    ├── GL-16.jpg            ギャラリー16枚目
    ├── Room-101-1.jpg       101号室 間取り図(1枚目固定)
    ├── Room-101-2.jpg       101号室 写真1
    ├── Room-101-3.jpg       101号室 写真2
    ├── Room-101-4.jpg       101号室 写真3
    ├── Room-101-5.jpg       101号室 写真4
    ├── Room-102-1.jpg       102号室 間取り図
    ├── Room-102-2.jpg       〜
    │    …(Room-102-3, 4)…
    ├── Room-102-5.jpg       102号室 写真4
    ├── Room-103-1.jpg       103号室 間取り図
    ├── Room-103-2.jpg       〜
    │    …(Room-103-3, 4)…
    └── Room-103-5.jpg       103号室 写真4
```

**命名規則のルール**
- **HR-XX** (Hero): ヒーローのカルーセル画像 5枚
- **GL-XX** (Gallery): ギャラリーセクションのタイル画像 16枚
- **Room-XXX-N**: 各部屋のカルーセル(1枚目=間取り図、2-5枚目=室内写真)、部屋3室×5枚=15枚
